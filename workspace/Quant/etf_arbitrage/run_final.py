...
class ETFArbitrageSimple:
    ...
    def get_etf_quote(self, etf_code):
        ...
        try:
            ...
            url = f"http://push2.eastmoney.com/api/qt/stock/get?secid={secid}&fields=f43,f44,f45,f46,f47,f48,f55,f57,f58,f60,f170,f171"
    ...
    def get_etf_iopv(self, etf_code):
        ...
        try:
            ...
            url = f"http://push2.eastmoney.com/api/qt/stock/get?secid={secid}&fields=f51,f52"
